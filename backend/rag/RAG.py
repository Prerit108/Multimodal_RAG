...
# Basic overall RAG pipeline to create a knowledge base consisting N number of documents .
# Use a local inference of Vision Model (Cloud model will result in high cost if scanning images also)
